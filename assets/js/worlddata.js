...
fetch('https://api.worldbank.org/v2/country/1W/indicator/SP.POP.TOTL/?format=json&date=2010:2020&per_page=5000')
     ...
     function appendpopData(popdata) {
            let WorldPopData = document.getElementById("Worldpop").innerHTML = 'World population' + ' [ ' + popdata[1][1].date + ' ]: ' + (popdata[1][1].value/1000000000).toFixed(2) + '  billion people';
       }
...
fetch("https://api.worldbank.org/v2/en/country/1W/indicator/SP.DYN.LE00.IN?format=json&per_page=100&source=2&date=2010:2020")
        ...
        let WorldageData = document.getElementById("ageData").innerHTML = 'Mean life expectence' + ' [ ' + agedata[1][2].date + ' / World ]: ' + agedata[1][2].value.toFixed(1) + '  year';
        }
        ...
        let WorldpovertyData = document.getElementById("povertyData").innerHTML = 'Poverty headcount ratio at $1.90 a day (% of population)' + ' [ ' + povertydata[1][3].date + ' / World ]: ' + povertydata[1][3].value.toFixed(2) + '  %';
        }
        ...
        let WorldCO2Data = document.getElementById("CO2Data").innerHTML = 'Annual carbon dioxide emissions '+ '[ ' + CO2data[1][4].date + ' / World ]: ' + CO2data[1][4].value.toFixed(2) + '  Kilo tonnes';        //Carbon dioxide emissions
        }